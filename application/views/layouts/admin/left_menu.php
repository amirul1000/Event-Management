...
<nav>
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li <?php if($this->router->fetch_class()=="attendees"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/attendees/index'); ?>"><i class="icon_table"></i>Attendees</a></li>
<li <?php if($this->router->fetch_class()=="event_sponsors"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/event_sponsors/index'); ?>"><i class="icon_table"></i>Event Sponsors</a></li>
<li <?php if($this->router->fetch_class()=="event_staff"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/event_staff/index'); ?>"><i class="icon_table"></i>Event Staff</a></li>
<li <?php if($this->router->fetch_class()=="events"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/events/index'); ?>"><i class="icon_table"></i>Events</a></li>
<li <?php if($this->router->fetch_class()=="organizers"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/organizers/index'); ?>"><i class="icon_table"></i>Organizers</a></li>
<li <?php if($this->router->fetch_class()=="tickets"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/tickets/index'); ?>"><i class="icon_table"></i>Tickets</a></li>
<li <?php if($this->router->fetch_class()=="venues"){?>class="active"<?php }?>><a href="<?php echo site_url('admin/venues/index'); ?>"><i class="icon_table"></i>Venues</a></li>
